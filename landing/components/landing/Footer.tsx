      ...
      <div className="mx-auto max-w-7xl px-5 py-14 lg:px-8">
        <div className="grid gap-10 lg:grid-cols-12">
          <div className="lg:col-span-5">
            <a href="#top" className="flex items-center gap-2.5" aria-label="DataGate — góra strony">
              <span
                className="relative inline-flex h-8 w-8 overflow-hidden rounded-lg bg-ink"
                aria-hidden="true"
              >
